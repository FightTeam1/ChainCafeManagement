...
namespace BLL.serviceHoaDon {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="WS_HoaDonSoap", Namespace="http://tempuri.org/")]
    public partial class WS_HoaDon : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public WS_HoaDon() {
            this.Url = global::BLL.Properties.Settings.Default.BLL_serviceHoaDon_WS_HoaDon;
        ...
        /// <remarks/>
        public void AddAsync(string MaNV, string Sdt_KH, string DiaChi) {
            this.AddAsync(MaNV, Sdt_KH, DiaChi, null);
        }
        
        /// <remarks/>
        public void AddAsync(string MaNV, string Sdt_KH, string DiaChi, object userState) {
            ...
            this.InvokeAsync("Add", new object[] {
                        MaNV,
                        Sdt_KH,
                        DiaChi}, this.AddOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void FindAsync(string MaHoaDon) {
            this.FindAsync(MaHoaDon, null);
        }
        
        /// <remarks/>
        public void FindAsync(string MaHoaDon, object userState) {
            ...
            this.InvokeAsync("Find", new object[] {
                        MaHoaDon}, this.FindOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void DeleteAsync(string MaHoaDon) {
            this.DeleteAsync(MaHoaDon, null);
        }
        
        /// <remarks/>
        public void DeleteAsync(string MaHoaDon, object userState) {
        ...
        public bool Update(string MaHoaDon, string MaNV, string Sdt_KH, System.DateTime NgayGioLap, int ThanhTien, string TrangThai, string DiaChi, string LoaiHD) {
        ...
        /// <remarks/>
        public void UpdateAsync(string MaHoaDon, string MaNV, string Sdt_KH, System.DateTime NgayGioLap, int ThanhTien, string TrangThai, string DiaChi, string LoaiHD) {
            this.UpdateAsync(MaHoaDon, MaNV, Sdt_KH, NgayGioLap, ThanhTien, TrangThai, DiaChi, LoaiHD, null);
        }
        
        /// <remarks/>
        public void UpdateAsync(string MaHoaDon, string MaNV, string Sdt_KH, System.DateTime NgayGioLap, int ThanhTien, string TrangThai, string DiaChi, string LoaiHD, object userState) {
            ...
            this.InvokeAsync("Update", new object[] {
                        ...
                        TrangThai,
                        DiaChi,
                        LoaiHD}, this.UpdateOperationCompleted, userState);
        }
