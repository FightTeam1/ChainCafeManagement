...
namespace BLL.serviceNhanVien {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="WS_NhanVienSoap", Namespace="http://tempuri.org/")]
    public partial class WS_NhanVien : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public WS_NhanVien() {
            this.Url = global::BLL.Properties.Settings.Default.BLL_serviceNhanVien_WS_NhanVien;
        ...
        /// <remarks/>
        public void AddAsync(string MaNV, string MaLoaiNV, string MaCS, string HoTenNV, string Sdt_NV, string Cmnd, string Email, string DiaChi_NV, string MatKhau) {
            this.AddAsync(MaNV, MaLoaiNV, MaCS, HoTenNV, Sdt_NV, Cmnd, Email, DiaChi_NV, MatKhau, null);
        }
        
        /// <remarks/>
        public void AddAsync(string MaNV, string MaLoaiNV, string MaCS, string HoTenNV, string Sdt_NV, string Cmnd, string Email, string DiaChi_NV, string MatKhau, object userState) {
            ...
            this.InvokeAsync("Add", new object[] {
                        ...
                        Email,
                        DiaChi_NV,
                        MatKhau}, this.AddOperationCompleted, userState);
        }
        ...
        public NHANVIEN[] FindAll() {
            object[] results = this.Invoke("FindAll", new object[0]);
            return ((NHANVIEN[])(results[0]));
        }
        ...
        /// <remarks/>
        public void FindAsync(string MaNV) {
            this.FindAsync(MaNV, null);
        }
        
        /// <remarks/>
        public void FindAsync(string MaNV, object userState) {
            ...
            this.InvokeAsync("Find", new object[] {
                        MaNV}, this.FindOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void DeleteAsync(string MaNV) {
            this.DeleteAsync(MaNV, null);
        }
        
        /// <remarks/>
        public void DeleteAsync(string MaNV, object userState) {
        ...
        /// <remarks/>
        public void UpdateAsync(string MaNV, string MaLoaiNV, string MaCS, string HoTenNV, string Sdt_NV, string Cmnd, string Email, string DiaChi_NV, string MatKhau) {
            this.UpdateAsync(MaNV, MaLoaiNV, MaCS, HoTenNV, Sdt_NV, Cmnd, Email, DiaChi_NV, MatKhau, null);
        }
        
        /// <remarks/>
        public void UpdateAsync(string MaNV, string MaLoaiNV, string MaCS, string HoTenNV, string Sdt_NV, string Cmnd, string Email, string DiaChi_NV, string MatKhau, object userState) {
            ...
            this.InvokeAsync("Update", new object[] {
                        ...
                        Email,
                        DiaChi_NV,
                        MatKhau}, this.UpdateOperationCompleted, userState);
        }
    ...
    public partial class FindAllCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public NHANVIEN[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((NHANVIEN[])(this.results[0]));
            }
        }
    }
